...
const SimulatePauseButton = ({ isSimulating, onStartSimulate, onPauseSimulate, currentTimeStep, handleSeekBarChange, index }) => {
  return (
    <div className="flex items-center border border-black bg-gray-100 hover:bg-gray-200 font-bold py-2 px-4 rounded flex-col justify-center mr-2">
      <div className='absolute top-0 left-1'>Drone {index + 1}</div>
